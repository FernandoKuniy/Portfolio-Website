...
export default function Home() {
  ...
  return (
    <div className="lg:col-start-2">
      <section id="about" className="scroll-mt-24 pt-0 lg:pt-24 pb-12">
        <div className="space-y-4">
          <p className="text-[15px] leading-7 text-[var(--muted)] md:text-base">
      ...
      <section id="experience" aria-labelledby="exp-h" className="scroll-mt-24 py-12">
        <h2 id="exp-h" className="text-2xl font-semibold text-[#e6e9f1] md:text-3xl tracking-tight">Experience</h2>
        <div className="mt-6">
