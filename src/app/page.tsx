    ...
    <div className="lg:col-start-2">
      <section id="about" className="scroll-mt-24 pt-8 lg:pt-24 pb-12">
        <div className="space-y-4">
          <p className="text-sm leading-6 text-[var(--muted)] sm:text-[15px] sm:leading-7 md:text-base">
          ...
          <p className="text-sm leading-6 text-[var(--muted)] sm:text-[15px] sm:leading-7 md:text-base">
            Currently, I'm the <span className="font-medium text-[#e6e9f1]">Lead Developer and Co-founder at SeekLab</span>, where I built and scaled 
          ...
          <p className="text-sm leading-6 text-[var(--muted)] sm:text-[15px] sm:leading-7 md:text-base">
            Previously, I contributed to the development of <span className="font-medium text-[#e6e9f1]">Snazz</span>, an iOS screen-time management app, 
            ...
            at <span className="font-medium text-[#e6e9f1]">Itaú Unibanco</span>, where I automated reporting workflows and supported market analysis for 
      ...
      <section id="experience" aria-labelledby="exp-h" className="scroll-mt-24 py-8 sm:py-12">
        <h2 id="exp-h" className="text-xl font-semibold text-[#e6e9f1] sm:text-2xl md:text-3xl tracking-tight">Experience</h2>
        <div className="mt-6">
      ...
      <section id="projects" aria-labelledby="proj-h" className="scroll-mt-24 py-8 sm:py-12">
        <h2 id="proj-h" className="text-xl font-semibold text-[#e6e9f1] sm:text-2xl md:text-3xl tracking-tight">Projects</h2>
