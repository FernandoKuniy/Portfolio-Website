        ...
        {sections.map((s) => {
          ...
          return (
            <a
              key={s.id}
              href={`/#${s.id}`}
              className={`relative text-base transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ring)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--bg)] ${
                isActive
