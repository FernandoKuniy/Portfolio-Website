              ...
              <div className="text-base font-medium text-[var(--foreground)]">
                ...
                {it.url ? (
                  <a 
                    ...
                    className="relative inline-flex items-center gap-1 text-[var(--accent-500)] transition-all duration-300 hover:text-[var(--accent-400)] before:absolute before:bottom-0 before:left-0 before:h-px before:w-0 before:bg-[var(--accent-500)] before:transition-all before:duration-300 hover:before:w-full"
                  >
                    {it.company}
